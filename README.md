...
| <span style="font-size: 16px;">1. 웹 페이지 접속</span> | <span style="font-size: 16px;">2. Emotion TTS로 변환할 이미지 업로드</span> | <span style="font-size: 16px;">3. 텍스트를 Emotional Speech로 변환</span> |
| :---: | :---: | :---: |
